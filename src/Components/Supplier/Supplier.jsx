...
let data = [
  [
    "Sell online to 10 Cr+ customers at",
    "0% Commission",
  ...
  [
    "Online Selling made ",
    "Simple",
    "Become a Meesho seller and start selling products online at 0% commission to crores of customers",
  ],
  [
    "How to Sell on",
    "Meesho",
    "Become a Meesho seller and join 4 lakh+ sellers who are growing their business everyday",
  ],
  [
    "Pricing & Commission",
    "0%",
    "Meesho charges 0% Commission rate across all categories making it the most profitable platform for you to sell online.",
  ],
  [
    "Meesho Shipping, Delivery & Returns",
    "Policy",
    "Get your products delivered to crores of customers with the lowest shipping charges.",
  ],
  [
    "Grow Your Business with",
    "Meesho",
    "Sell your products online and reach crores of customers through Meesho’s selling tools for suppliers",
  ],
];
